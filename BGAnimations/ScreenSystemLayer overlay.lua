local function CreditsText(playr)
	...
	elseif playr == 'SOLO' then
		posX=SCREEN_CENTER_X-95;
	end

	return LoadFont("ScreenSystemLayer credits normal")..{
		InitCommand=cmd(x,posX;y,SCREEN_BOTTOM-10;diffuseblink;effectcolor1,1,1,1,1;effectcolor2,1,1,1,0;playcommand,"Refresh");
...
local function OtherText()
	return LoadFont("ScreenSystemLayer credits normal")..{
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_BOTTOM-10;diffuseblink;effectcolor1,1,1,1,1;effectcolor2,1,1,1,0;playcommand,"Refresh");
		RefreshCommand=function(self)
